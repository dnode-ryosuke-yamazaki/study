...
依頼IDを唯一の共有点として、依頼・候補・選択結果・作成結果・予定詳細・選択画面を
...
def 予定詳細依頼ファイル(設定値: 設定, 依頼id: str) -> Path:
    return 設定値.予定詳細依頼フォルダ / f"detail-request-{依頼id}.json"


def 予定詳細ファイル(設定値: 設定, 依頼id: str) -> Path:
    return 設定値.予定詳細フォルダ / f"detail-{依頼id}.json"
