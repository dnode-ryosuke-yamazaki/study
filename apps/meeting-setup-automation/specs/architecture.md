...
- **Power Automateのフォルダ監視トリガーには検知の待ちがある。** OneDrive同期のラグと合わせて、依頼から候補の到着までに待ちが発生する前提で設計する。往復時間の実測と、そこから待ち上限を決める手順は[meeting-scheduling/tasks.md](meeting-scheduling/tasks.md#仕様承認pr前に行う実機確認)のE1にある
